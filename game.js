...
=======
        ...
        this.maxSleepingPokemons = Math.max(1, Math.floor(this.pokemons.length * 0.3)); // Минимум 1 спящий покемон
        
        console.log('Инициализация механики сна:');
...
=======
                    ...
                    this.ctx.fillStyle = 'rgba(0, 0, 0, 0.7)';
                    const sleepText = 'Z';
                    const zOffset = Math.sin(this.animationFrame * 0.1) * 5;
                    
                    // Рисуем несколько Z разного размера
                    for (let i = 0; i < 3; i++) {
                        const size = 12 + i * 4;
